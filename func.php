...
{
	$name=$_POST['name'];
	$query="insert into docttb(name)values('$name')";
	$result=mysqli_query($con,$query);
	if($result)
 ...
 <div class="jumbotron" id="ab1"></div>
  ...
  <div class="col-md-4">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a href="Patient_details.php" class="list-group-item list-group-item-action" aria-controls="messages">Patient Details</a>
